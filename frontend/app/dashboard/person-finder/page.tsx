      ...
      <div className="grid flex-1 items-start gap-4 p-4 md:grid-cols-[240px_1fr] lg:grid-cols-[240px_1fr] lg:gap-8 lg:p-8">
        ...
        <main className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <h1 className="text-xl font-bold md:text-2xl">Person Finder</h1>
          </div>
          <Tabs defaultValue="detection">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Real-time person recognition detection
                    </CardDescription>
                  </CardHeader>
                          ...
                          {appData && appData.lookoutVehicles.length > 0 ? (
                            ...
                            <Alert className=" text-blue-800 ">
                              <AlertTitle className="text-sm font-medium">
                                No Person on lookout
                              </AlertTitle>
                              <AlertDescription className="text-xs">
                                Upload Person Image for lookout
                              </AlertDescription>
                            </Alert>
                          )}
                        </CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Monitoring for person recognition
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-0">
                    <StreamVideo activeModel="personDetector" />
                    <div className="p-4">
            ...
            <TabsContent value="history" className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Person Recognition History</CardTitle>
                  <CardDescription>
                    Record of personS detected by the system
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
